...
insert into dimRestaurant values('Domino''s', 'dAddress 1');
insert into dimRestaurant values('Domino''s', 'dAddress 2');
insert into dimRestaurant values('Domino''s', 'dAddress 3');
insert into dimRestaurant values('Subway', 'sAddress 1');
insert into dimRestaurant values('Subway', 'sAddress 2');
insert into dimRestaurant values('Pizza Hut', 'pAddress 1');
insert into dimRestaurant values('Burger King', 'bAddress 1');
insert into dimRestaurant values('Burger King', 'bAddress 2');
insert into dimRestaurant values('Burger King', 'bAddress 3');
insert into dimRestaurant values('Burger King', 'bAddress 4');
insert into dimRestaurant values('Starbucks', 'cAddress 1');
insert into dimRestaurant values('Starbucks', 'cAddress 2');
insert into dimRestaurant values('Starbucks', 'cAddress 3');
insert into dimRestaurant values('Starbucks', 'cAddress 4');
insert into dimRestaurant values('Starbucks', 'cAddress 5');
...
-- factTable Inserts
-- Domino's
insert into factTable values(1, 1, 1, 1, 3.8, 450, 23);
insert into factTable values(2, 4, 1, 1, 1.7, 123, 12);
insert into factTable values(3, 5, 1, 1, 4.5, 632, 69);

-- Subway
insert into factTable values(4, 3, 3, 2, 0.7, 897, 9);
insert into factTable values(5, 4, 3, 2, 2.4, 146, 45);

-- Pizza Hut
insert into factTable values(6, 6, 1, 3, 1.9, 245, 36);

-- Burger King
insert into factTable values(7, 2, 1, 3, 4.7, 12, 67);
insert into factTable values(8, 2, 1, 3, 2.3, 420, 45);
insert into factTable values(9, 3, 1, 3, 2.2, 57, 78);
insert into factTable values(10, 4, 1, 3, 4.1, 75, 15);

-- Starbucks
insert into factTable values(11, 3, 2, 4, 2.9, 41, 89);
insert into factTable values(12, 5, 2, 4, 0.8, 86, 42);
insert into factTable values(13, 6, 2, 4, 1.1, 186, 123);
insert into factTable values(14, 2, 2, 4, 0.9, 16, 23);
insert into factTable values(15, 1, 2, 4, 1.9, 40, 29);
